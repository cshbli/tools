...
class Dataset(object):
    ...
    def __init__(self, name, data_dir=None, num_classes=IMAGENET_NUM_CLASSES):
        self.name = name
...
class ImagenetData(Dataset):
    ...
    def __init__(self, data_dir=None):
        super(ImagenetData, self).__init__('ImageNet', data_dir=data_dir)
    ...
    def get_image_preprocessor(self, benchmark=False):
        if benchmark:
            ...
            return preprocessing.ImagePreprocessor
